...
class GameScene extends Phaser.Scene{
  ...
  preload(){
    ...
    this.load.image("apple", "/asset/apple.png")
    this.load.audio("coin", "/asset/coin.mp3")
    this.load.audio("bgMusic", "/asset/bgMusic.mp3");
  }
  ...
  create(){
    ...
    this.player.setSize(this.player.width - this.player.width / 4, this.player.height / 6)
                 .setOffset(this.player.width / 10, this.player.width / 10);
